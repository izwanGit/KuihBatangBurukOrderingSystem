...
<fieldset>
  ...
  <b>User Data</b>
	<?php
		...
		/* execute SQL statement */
		$query= "(SELECT * FROM product WHERE pro_name LIKE '%$productsearch%' )";
		$result = mysqli_query($dbconn, $query) or die ("Error: " . mysqli_error($dbconn));
		$numrow = mysqli_num_rows($result);
   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr align="left" bgcolor="#f2f2f2">
        ...
        <th width="25%">Product Net Weight</th>
	  ...
	  ?>
        <td>&nbsp;<?php echo $a+1; ?></td>
        <td>&nbsp;<?php echo ucwords (strtolower($row['PRO_NAME'])); ?></td>
        <td>&nbsp;<?php echo ucwords (strtolower($row['PRO_FLAVOR'])); ?></td>   
        <td>&nbsp;<?php echo ucwords (strtolower($row['PRO_NET_WEIGHT'])); ?></td>   
        <td>&nbsp;<?php echo $row['PRO_PRICE']; ?></td>
        <td width="5%" align="center"><a class="one" href="detail_product.php?id=<?php echo $row['PRO_ID'];?>">Detail</a></td>
       </tr> 
      <?php 
       $color="2";}
	   else{
