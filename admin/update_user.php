...
<form name="edit_user" method="post" action="db_update_user.php" enctype="multipart/form-data">
    <table width="80%" border="0" align="center">
	  ...
	  <tr>
        ...
        <td><input type="text" name="user_phoneno" size="50" value="<?php echo $row['USER_PHONENO']; ?>"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="user_username" size="50" value="<?php echo $row['USER_USERNAME']; ?>" /></td> 
      </tr>
      <tr>
        <td width="16%">Password</td>
        <td><input type="password" name="user_password" size="50" value="<?php echo $row['USER_PASSWORD']; ?>" /></td> 
      </tr>
