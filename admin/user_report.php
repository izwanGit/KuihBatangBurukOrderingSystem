...
<br>
  ...
  <h3>User Data</h3>
	<?php
        ...
        INNER JOIN orderproduct ON order_.ORDER_ID = orderproduct.ORDER_ID WHERE order_.ORDER_STATUS = 1 ORDER BY order_.ORDER_ID;";
   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr align="left" bgcolor="#f2f2f2">
        ...
        <th width="26%">Name</td>       
        <th width="27%">Product</td>
        <th width="9%">Ordered Date</td>
      </tr>
