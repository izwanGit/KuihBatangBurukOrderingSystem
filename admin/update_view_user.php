...
<div class="container">
  ...
  <h3>Administrator Data</h3>
	<?php
		$query = "SELECT * FROM user  WHERE lvl_id = 1 ORDER BY user_name";
   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td><?php echo ucwords (strtolower($row['USER_ADDRESS'])); ?></td>
        <td>&nbsp;<?php echo $row['USER_PHONENO']; ?></td>
        <td width="5%" align="center"><a class="one" href="update_admin.php?user=<?php echo $row['USER_USERNAME'];?>">Edit</a></td>
        <td width="5%" align="center">&nbsp;</td>
      </tr>
	   <?php
	    $color="1";
   ...
   <tr align="left" bgcolor="#f2f2f2">
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        ...
        <td width="5%" align="center"><a class="one" href="delete_user.php?user_id=<?php echo $row['USER_ID'];?>" onclick="clicked(event)">Delete</a></td>
      </tr> 
      <?php 
       $color="2";}
	   else{
	  ...
	  ?>
        ...
        <td>&nbsp;<?php echo $row['USER_PHONENO']; ?></td>
        <td width="5%" align="center"><a class="one" href="update_user.php?user_id=<?php echo $row['USER_ID'];?>">Edit</a></td>
        <td width="5%" align="center"><a class="one" href="db_delete_user.php?user_id=<?php echo $row['USER_ID'];?>" onclick="clicked(event)">Delete</a></td>
      </tr>
	   <?php
	    $color="1";
	   }
